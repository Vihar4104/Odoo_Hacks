...
const TaskList = ({ tasks, onSelectTask }) => {
  ...
  return (
    <div className="task-list p-8 border rounded-lg shadow-lg bg-white transition-transform transform hover:scale-105 w-full lg:w-1/2">
      ...
      <ul className="space-y-4">
        {tasks.map((task) => (
          <li
            ...
            className="cursor-pointer p-6 border rounded-lg shadow-sm hover:bg-gray-100 transition-colors flex items-center text-lg"
          >
