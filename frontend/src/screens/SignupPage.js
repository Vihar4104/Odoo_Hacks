...
function SignupPage() {
    ...
    return (
        <div className="signup-container h-screen flex justify-center items-center bg-white">
            <div className="flex justify-between items-center w-full max-w-5xl gap-2.5">
                <div className="glass-signup w-1/2 rounded-2xl backdrop-filter backdrop-blur-md shadow-md bg-gray-100 p-7">
                    <div className="form-container">
                        <h1 className="signup-heading text-2xl font-bold mb-5 text-black">Sign Up</h1>
                        ...
                        <input
                            ...
                            className="input-field w-full p-3 mb-4 border-0 rounded-md bg-gray-200 text-gray-700 focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500"
                        />
