...
//   return (
//     <div className="signup-container h-screen flex justify-center items-center bg-gray-50">
//       <div className="flex justify-between items-center w-full max-w-5xl gap-5">
//         {/* Sign Up Form */}
//         <div className="signup-form w-1/2 max-w-md bg-white rounded-2xl shadow-2xl p-8 space-y-6">
//           <header className="header p-4 text-center mb-6">
//             <h1 className="text-3xl font-bold text-gray-800">Litter Link</h1>
//           </header>
//           <div className="form-container">
//             <h1 className="signup-heading text-2xl font-bold text-gray-800 mb-5">Sign Up</h1>
...
//               className="input-field w-full p-3 mb-4 border border-gray-300 rounded-md bg-gray-100 text-gray-700 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
//             />
...
//               className="signup-button w-full p-3 bg-blue-600 text-white rounded-md shadow-lg hover:bg-blue-700 transition duration-300"
//             >
//               Sign Up
//             </button>
            
//             <p className="login-text text-right mt-3 text-gray-700">
